    ...
    const onSubmitUpdate = async (e) => {
        ...
        try {
            ...
            if (image.size !== 0) {
                ...
                updateAboutData.imageUrl = link;
                updateAboutData.deletehash = deletehash;
            }
                ...
                <form onSubmit={onSubmitUpdate}>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="imageUrl" defaultValue={about?.imageUrl} />
